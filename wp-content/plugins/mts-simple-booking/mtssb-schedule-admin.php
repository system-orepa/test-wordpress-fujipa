				...
				for ($i = 0, $day = 1 - $starti; $i <= $endi ; $i++, $day++) {
					...
					if (0 < $day && $day <= $endd) {
						...
						$day = sprintf("%02d", $day);
                                                ...
                                                // 農園さん向け予約調整ラジオボタン
                                                echo "<div class=\"farm-stop" . (-100 == $schedule[$day]['delta'] ? ' stop' : '') . "\"><input type=\"hidden\" name=\"schedule[$day][delta]\" value=\"0\"$disabled />";
                                                echo "<input id=\"schedule-open-$day\" type=\"radio\" name=\"schedule[$day][delta]\" value=\"0\"" . (0 == $schedule[$day]['delta'] ? ' checked="checked"' : '') . " $disabled />";
                                                echo "<input id=\"schedule-open-$day\" type=\"radio\" name=\"schedule[$day][delta]\" value=\"-20\"" . (-20 == $schedule[$day]['delta'] ? ' checked="checked"' : '') . " $disabled />";
                                                echo "<input id=\"schedule-open-$day\" type=\"radio\" name=\"schedule[$day][delta]\" value=\"-40\"" . (-40 == $schedule[$day]['delta'] ? ' checked="checked"' : '') . " $disabled />";
                                                echo "<input id=\"schedule-open-$day\" type=\"radio\" name=\"schedule[$day][delta]\" value=\"-100\"" . (-100 == $schedule[$day]['delta'] ? ' checked="checked"' : '') . " $disabled />";
                                                print_r($schedule[$day][delta]);
                                                echo "</div>";
