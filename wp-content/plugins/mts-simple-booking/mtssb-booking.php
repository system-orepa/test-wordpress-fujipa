...
class MTSSB_Booking
{
	...
	public function find_by_reserveid($reserve_id, $email, $time=0)
	{
		...
		$sql = $wpdb->prepare("
			...
			WHERE mod(booking_id, 100000)=%d AND client like %s AND booking_time>=%d
	...
	public function del_booking($id=0) {
        ...
        /**
         * Copy booking data
         * added by kazuya.okamoto 2019.09.16
         */
        public function copy_booking($id=0) {
                global $wpdb;
                ...
                $result = $wpdb->query("
                        INSERT INTO wp_mtssb_booking_delete
                        SELECT *
